...
public class ContenidoTerceroM {
    ...
    public void Lenguaje() throws IOException {
        ...
        Lenguaje.LenguajeTerceroM(OpcionTemas);
    ...
    public void Matematicas() throws IOException {
        ...
        Matematica.MatematicaTerceroM(OpcionTemas);
    }
    ...
    public void Historia() throws IOException {
        ...
        Historia.HistoriaTerceroM(OpcionTemas);
    }
    ...
    public void Ciencias() throws IOException {
        ...
        Ciencias.CienciasTerceroM(OpcionTemas);
    }
